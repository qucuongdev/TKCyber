    ...
    <section id="home" className="relative min-h-screen flex flex-col justify-center items-center pt-20 overflow-hidden bg-sec-main">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        <p className="max-w-2xl mx-auto text-lg md:text-xl text-indigo-200/80 mb-10 leading-relaxed font-light">
          A blog sharing knowledge about <span className="text-cyan-400 font-medium">Offensive Security</span>, <span className="text-purple-400 font-medium">SOC</span>, <span className="text-cyan-400 font-medium">GRC</span> and <span className="text-purple-400 font-medium">AI Security</span>.
        </p>

        {/* CTA Buttons */}
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
          <button className="px-8 py-3.5 bg-cyan-400 text-indigo-950 font-bold rounded-full hover:bg-cyan-300 transition-all duration-300 shadow-[0_0_20px_rgba(34,211,238,0.4)] flex items-center gap-2">
            Explore Now
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
          </button>
          <button className="px-8 py-3.5 border border-white/20 text-white rounded-full hover:bg-white/10 transition-all duration-300 font-mono bg-white/5 backdrop-blur-sm">
            View Topics
          </button>
        </div>
